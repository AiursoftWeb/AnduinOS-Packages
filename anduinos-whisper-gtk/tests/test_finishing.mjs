...
context.global = {display: {focus_window: {get_wm_class: () => 'org.gnome.Ptyxis'}}};
controller._clipboard = {set_text: (_kind, text) => { clipboard = text; }};
const terminalPasteModes = [];
controller._pressPaste = terminal => {
    terminalPasteModes.push(terminal);
...
assert.deepEqual(terminalPasteModes, [true, true]);
