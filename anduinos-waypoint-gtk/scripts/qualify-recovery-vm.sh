...
readonly CLI="${ANDUINOS_WAYPOINT_CLI:-/usr/bin/anduinos-waypoint-cli}"
readonly STATE_DIR="/var/log/anduinos-waypoint-qualification"
readonly STATE_FILE="$STATE_DIR/state.json"
readonly MARKER_FILE="/etc/anduinos-waypoint-qualification-marker"
...
require_environment() {
    ...
    [[ -x "$CLI" ]] || die "the installed AnduinOS Waypoint CLI is unavailable"
...
prepare_rollback() {
    ...
    baseline="waypoint-baseline-$run_id"
