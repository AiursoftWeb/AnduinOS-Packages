...
Waypoint has two independent local snapshot streams and no combined rollback:
...
session `file-history` GApplication action. Waypoint canonicalizes and validates
